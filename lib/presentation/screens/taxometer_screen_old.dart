...
//   int get _freeWaitingTime => _taxometerService.freeWaitingTime;
...
//   //   // Start service and sync state
//   //   print('[TAXOMETER_SCREEN] Starting taxometer service...');
//   //   await _taxometerService.startTaxometer();

//   //   print('[TAXOMETER_SCREEN] Service started, syncing state...');
//   //   setState(() {
//   //     _isRunning = _taxometerService.isRunning;
//   //     _isWaiting = _taxometerService.isWaiting;
//   //     _currentFare = _taxometerService.currentFare;
//   //     _distance = _taxometerService.distance;
//   //     _elapsedTime = _taxometerService.elapsedTime;
//   //   });

//   //   print(
//   //       '[TAXOMETER_SCREEN] State synced - isRunning: $_isRunning, service.isActive: ${_taxometerService.isActive}');
...
//   // void _stopTaxometer() {
//   //   print('[TAXOMETER_SCREEN] Stopping taxometer service...');
...
//   //   print(
//   //       '[TAXOMETER_SCREEN] Taxometer stopped - isRunning: $_isRunning, service.isActive: ${_taxometerService.isActive}');
...
//                         width: double.infinity,
//                         child: ElevatedButton(
//                           onPressed: _taxometerService.onArrived,
//                           style: ElevatedButton.styleFrom(
//                             backgroundColor: Colors.green,
...
//                                           icon: Icons.timer,
//                                           label: 'Время',
//                                           value: _taxometerService.formatTime(_elapsedTime),
...
//                         ? _taxometerService.stopTaxometerWithConfirmation
//                         : _taxometerService.startDriving),
//               ),
//             ],
//           ),
//         ));
